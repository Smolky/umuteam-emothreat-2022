...
class NGramsTransformer (BaseEstimator, TransformerMixin):
    ...
    def __init__ (self, cache_file = '', field = '', max_features = 100):
        """
        ...
        self.suggested_field = 'tweet_clean_lowercase'
    ...
    def get_feature_names (self):
        ...
        return [self.prefix + '_' + str (x) for x in range (self.ngrams_vectorizer.named_steps['reduction'].get_params ()['n_components'])]
