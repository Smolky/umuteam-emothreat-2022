...
class ClassicMachineLearningTechniques (BaseModel):
    ...
    def get_folder (self):
        ...
        @inherit
        """
        return self.folder or 'classic-' + '-'.join (self.get_feature_combinations ())
    ...
    def train (self, force = False):
        ...
        best_model_file = self.dataset.get_working_dir (self.dataset.task, 'models', model_folder, 'best_model.joblib')
        ...
        summary_path = self.dataset.get_working_dir (self.dataset.task, 'models', model_folder, 'hyperparameters.csv')
    ...
    def predict (self, using_official_test = False, callback = None):
        ...
        model_filename = self.dataset.get_working_dir (self.dataset.task, 'models', model_folder, 'best_model.joblib')
